...
RUN wget -O /tmp/grafana.deb https://s3-us-west-2.amazonaws.com/grafana-releases/release/grafana_4.5.2_amd64.deb; \
  sudo apt-get install -y adduser libfontconfig && sudo dpkg -i /tmp/grafana.deb
